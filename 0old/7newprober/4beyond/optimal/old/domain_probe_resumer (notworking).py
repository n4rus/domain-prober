...
def generate_candidates_from_dictionary(dict_file, tlds, empty_set, last_checked):
    """Generate domain candidates from a dictionary file, resuming from last checked domain."""
...
def generate_candidates_from_combinations(length, tlds, empty_set, last_checked):
    """Generate domain candidates from letter-digit combinations, resuming from last checked domain."""
